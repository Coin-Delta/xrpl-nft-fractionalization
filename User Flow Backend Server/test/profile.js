    ...
    it('it should GET profile', (done) => {
      chai
        ...
        .end((err, res) => {
          res.should.have.status(200)
          res.body.should.be.an('object')
          res.body.should.include.keys('firstName', 'email')
          done()
        })
    })
  })
  describe('/PATCH profile', () => {
    it('it should NOT UPDATE profile empty firstName/email', (done) => {
      const user = {}
      chai
        .request(server)
        .patch('/profile')
    ...
    it('it should UPDATE profile', (done) => {
      const user = {
        ...
        lastName: 'test',
        externalProfileLink: 'https://www.google.com'
      }
      chai
        .request(server)
        .patch('/profile')
