...
export const toggleSidebar = asyncAction(
    'nft/TOGGLE_SIDEBAR',
    'nft/TOGGLE_SIDEBAR_SUCCESS',
    'nft/TOGGLE_SIDEBAR_FAIL'
)();

export const saveWallet = asyncAction(
    'nft/SAVE_WALLET',
    'nft/SAVE_WALLET_SUCCESS',
    'nft/SAVE_WALLET_FAIL'
)();
