  ...
  const handleAcceptByOffer = async () => {
    ...
    try {
      axios({
        ...
        method: "post",
        url: `${process.env.REACT_APP_BACK_END_HOST}/fractionalize/accept_buy_offer`,
...
export default FractionFourthStep;
